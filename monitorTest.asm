...
_monitorTest:     file format elf32-i386
...
main() {
   ...
   f:	8d 45 c0             	lea    -0x40(%ebp),%eax
main() {
  12:	51                   	push   %ecx
  13:	83 ec 40             	sub    $0x40,%esp
    int init_array[5] = {1, 2, 3, 4, 5};
  16:	c7 45 c0 01 00 00 00 	movl   $0x1,-0x40(%ebp)
    if (monitor_init(1, init_array, 5) < 0) {
  1d:	6a 05                	push   $0x5
  1f:	50                   	push   %eax
  20:	6a 01                	push   $0x1
    int init_array[5] = {1, 2, 3, 4, 5};
  22:	c7 45 c4 02 00 00 00 	movl   $0x2,-0x3c(%ebp)
  29:	c7 45 c8 03 00 00 00 	movl   $0x3,-0x38(%ebp)
  30:	c7 45 cc 04 00 00 00 	movl   $0x4,-0x34(%ebp)
  37:	c7 45 d0 05 00 00 00 	movl   $0x5,-0x30(%ebp)
    if (monitor_init(1, init_array, 5) < 0) {
  3e:	e8 e0 03 00 00       	call   423 <monitor_init>
  43:	83 c4 10             	add    $0x10,%esp
  46:	85 c0                	test   %eax,%eax
  48:	0f 88 8e 00 00 00    	js     dc <main+0xdc>
  ...
  51:	6a 01                	push   $0x1
  53:	e8 d3 03 00 00       	call   42b <monitor_increase_all_elems>
  58:	83 c4 10             	add    $0x10,%esp
  5b:	85 c0                	test   %eax,%eax
  5d:	78 6a                	js     c9 <main+0xc9>
  ...
  5f:	56                   	push   %esi
  60:	56                   	push   %esi
  61:	8d 75 d4             	lea    -0x2c(%ebp),%esi
  64:	56                   	push   %esi
  65:	6a 01                	push   $0x1
  67:	e8 cf 03 00 00       	call   43b <monitor_read_shared_mem>
  6c:	83 c4 10             	add    $0x10,%esp
  6f:	85 c0                	test   %eax,%eax
  71:	0f 88 8b 00 00 00    	js     102 <main+0x102>
  ...
  87:	83 c4 10             	add    $0x10,%esp
        printf(1, "data[%d] = %d\n", i, data[i]);
  8a:	ff 34 9e             	push   (%esi,%ebx,4)
  8d:	53                   	push   %ebx
    for (int i = 0; i < 5; i++) {
  8e:	83 c3 01             	add    $0x1,%ebx
        printf(1, "data[%d] = %d\n", i, data[i]);
  91:	68 3d 08 00 00       	push   $0x83d
  96:	6a 01                	push   $0x1
  98:	e8 63 04 00 00       	call   500 <printf>
    for (int i = 0; i < 5; i++) {
  9d:	83 c4 10             	add    $0x10,%esp
  a0:	83 fb 05             	cmp    $0x5,%ebx
  a3:	75 e5                	jne    8a <main+0x8a>
    }

    if (monitor_close_shared_mem(1) < 0) {
  a5:	83 ec 0c             	sub    $0xc,%esp
  a8:	6a 01                	push   $0x1
  aa:	e8 84 03 00 00       	call   433 <monitor_close_shared_mem>
  af:	83 c4 10             	add    $0x10,%esp
  b2:	85 c0                	test   %eax,%eax
  b4:	78 39                	js     ef <main+0xef>
  ...
  b6:	50                   	push   %eax
  b7:	50                   	push   %eax
  b8:	68 d4 08 00 00       	push   $0x8d4
  bd:	6a 01                	push   $0x1
  bf:	e8 3c 04 00 00       	call   500 <printf>
  ...
  c9:	50                   	push   %eax
  ca:	50                   	push   %eax
  cb:	68 4c 08 00 00       	push   $0x84c
  d0:	6a 01                	push   $0x1
  d2:	e8 29 04 00 00       	call   500 <printf>
        exit();
  d7:	e8 97 02 00 00       	call   373 <exit>
        printf(1, "monitor_init failed\n");
  dc:	50                   	push   %eax
  dd:	50                   	push   %eax
  de:	68 28 08 00 00       	push   $0x828
  e3:	6a 01                	push   $0x1
  e5:	e8 16 04 00 00       	call   500 <printf>
        exit();
  ea:	e8 84 02 00 00       	call   373 <exit>
        printf(1, "monitor_close_shared_mem failed\n");
  ef:	52                   	push   %edx
  f0:	52                   	push   %edx
  f1:	68 b0 08 00 00       	push   $0x8b0
  f6:	6a 01                	push   $0x1
  f8:	e8 03 04 00 00       	call   500 <printf>
        exit();
  fd:	e8 71 02 00 00       	call   373 <exit>
        printf(1, "monitor_read_shared_mem failed\n");
 102:	53                   	push   %ebx
 103:	53                   	push   %ebx
 104:	68 70 08 00 00       	push   $0x870
 109:	6a 01                	push   $0x1
 10b:	e8 f0 03 00 00       	call   500 <printf>
        exit();
 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 60 09 00 00 	movzbl 0x960(%edx),%edx
 ...
 509:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 579:	ff 24 85 08 09 00 00 	jmp    *0x908(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 687:	90                   	nop
          s = "(null)";
 688:	ba fe 08 00 00       	mov    $0x8fe,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a1:	a1 10 0c 00 00       	mov    0xc10,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 10 0c 00 00    	mov    %edx,0xc10
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 10 0c 00 00    	mov    %edx,0xc10
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 10 0c 00 00    	mov    0xc10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d 10 0c 00 00    	mov    0xc10,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 10 0c 00 00    	mov    0xc10,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 10 0c 00 00    	mov    %edx,0xc10
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 10 0c 00 00 14 	movl   $0xc14,0xc10
 7f7:	0c 00 00 
    base.s.size = 0;
 7fa:	bf 14 0c 00 00       	mov    $0xc14,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 14 0c 00 00 14 	movl   $0xc14,0xc14
 806:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 18 0c 00 00 00 	movl   $0x0,0xc18
 812:	00 00 00 
    if(p->s.size >= nunits){
